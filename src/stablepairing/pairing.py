...
Based on McVitte and Wilson 1970 
(https://link.springer.com/content/pdf/10.1007/BF01934199.pdf)

Base functions of proposal, refusal and run are mostly straight from the paper,
except some tricky areas where the paper couldn't decide if it indexes by 0 or 
1 and we only index by zero here (so sometimes you'll see shifts of +/- 1 in 
the index, these are important!).
"""
